...
class ForwardPropagation:
    ...
    def updateEdgeWeight(self):
        for i in range(8):
            self.weight[i] = self.weight[0] - random.random() * self.Error

    def inputEdgeWeight(self):
        for i in range(8):
            self.weight[i] = float(i)
